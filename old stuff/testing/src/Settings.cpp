...
char* Settings::getWeek(){
    ...
    std::cout << "Heatlength: " << day[j].getHeatLength() << std::endl;
        std::cout << day[j].getDay() << std::endl;
        for(int i = 0; i < day[j].getHeatLength(); ++i){
            std::cout << "HeatBlock " << i+1 << std::endl;
            std::cout << "Start: " << day[j].getHeat()[i].getStart() << std::endl;
            std::cout << "End: " << day[j].getHeat()[i].getEnd() << std::endl;
            std::cout << "Temp: " << day[j].getHeat()[i].getTemp() << std::endl;
...
char* Settings::getDay(uint8_t d){
    std::cout << "Heatlength: " << day[d-1].getHeatLength() << std::endl;
    for(int i = 0; i < day[d-1].getHeatLength(); ++i){
        std::cout << "HeatBlock " << i+1 << std::endl;
        std::cout << "Start: " << day[d-1].getHeat()[i].getStart() << std::endl;
        std::cout << "End: " << day[d-1].getHeat()[i].getEnd() << std::endl;
        std::cout << "Temp: " << day[d-1].getHeat()[i].getTemp() << std::endl;
    ...
    /*readmode*/
        ...
        if(weekMode == 0){
            ...
            for(int i = 0; i < day[d-1].getHeatLength(); ++i){
                ...
                temp = (char*) realloc((void*)temp, size_T+1);
                answerLen_old = answerLen;
                answerLen += size_T;
                answer = (char*)realloc((void*)answer, answerLen);
